        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div v-if="errorMessage" class="alert alert-danger" v-html="errorMessage">
...
export default {
    ...
    methods : {
        saveItem() {
            if (this.item.id>0){
                axios.put('/users/' + this.item.id,this.item) //güncellemede put ile item id'si belirtilir
                    .then(response => {
                    ...
                    .catch(error => {
                        ...
                        if (error.response.data.errors) {
                            ...
                            }); //errors'teki tüm anahtarları almayı sağlar
                            this.errorMessage += "</ul>";
                        }
                    });
            } else {
